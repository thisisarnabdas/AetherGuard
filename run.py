...
# Define the base directory and paths for the database folder and file
...
# Initialize the database if it doesn't exist and apply migrations
with app.app_context():
    if not db_file_path.exists():  # Check if the database file exists
